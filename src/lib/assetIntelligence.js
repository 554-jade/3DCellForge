export const ASSET_CATEGORIES = [
  {
    ...
    description: 'A museum-style planet archive entry. The important visual signals are silhouette, surface relief, material aging, and readable symbolic details rather than mechanical precision.',
    value: 'Works best as slow archive data with side lighting, close orbit, and pauses on the face, edge profile, and weathered material transitions.',
    tags: ['artifact', 'patina', 'relief', 'museum display', 'archive data'],
  },
  {
    id: 'road',
    ...
    scale: 'Single vehicle planet',
    inspectionFocus: 'stance, wheels, glass canopy, front profile',
    description: 'A road-vehicle planet entry where stance, wheel placement, front profile, glass canopy, and body highlights decide whether the planet model feels believable.',
    value: 'Use a low camera, road push-in, and front three-quarter framing. The presentation should sell motion, gloss, and mass instead of treating it like a static specimen.',
  ...
  },
  {
    ...
    scale: 'Large vessel planet',
    inspectionFocus: 'hull length, deck plane, island tower, waterline',
    description: 'A naval-vessel planet entry. The key read is the long hull, deck plane, island/superstructure, and heavy silhouette rather than small decorative parts.',
  ...
  },
  {
    ...
    scale: 'Single aircraft planet',
    inspectionFocus: 'fuselage, wings, tail, canopy, engine areas',
    description: 'An aircraft planet entry where the fuselage centerline, wings, tail, canopy, and engine areas must stay coherent from multiple angles.',
    value: 'Use a flight-pass camera with banking, contrails, and forward drift. The presentation should make direction and lift obvious.',
  ...
  },
  {
    ...
    scale: 'Single product planet',
    inspectionFocus: 'silhouette, material zones, recognizable feature layout',
    description: 'A product planet entry. The planet model quality depends on whether the silhouette, primary material zones, and recognisable feature layout survived generation.',
  ...
  },
  {
    ...
    scale: 'Specimen-style planet',
    inspectionFocus: 'overall volume, translucent surface, internal clusters',
    description: 'An organic/specimen planet entry. The useful read is the overall volume, translucent surface, and clustered internal structure rather than exact biological accuracy.',
    value: 'Use close orbit, clean rim light, and slower zooms. This works best as an educational archive data view.',
    tags: ['specimen', 'organic', 'archive orbit', 'soft volume', 'education'],
  },
]
...
export const SCENE_PROFILES = {
  ...
  artifact: {
    ...
    summary: 'Dark gallery stage, warm spotlights, and close archive data.',
  ...
  product: {
    ...
    badges: ['turntable', 'reflection', 'archive pause'],
  },
  specimen: {
    id: 'specimen',
    label: 'Specimen Lab',
    ...
    badges: ['rim light', 'archive data', 'soft volume'],
  },
}
